...
export default function NewProduct() {
    ...
    return (
      <div className="new-product--main">
        ...
        <select
          value={ele.seller}
          onChange={(event) =>
            handleDataChange(event.target.value, "seller", index)
          }
        >
            {sellers.map((ele) => <option value={ele.name}>{ele.name}</option>)}
        </select>
        <br />
        <h2>GST</h2>
        <input
        ...
        <br />
        <br />
        <button onClick={() => delData(index)} className="delete">
          Delete
        </button>
        <hr />
      </div>
  ...
  return (
    <div className="new-product">
      ...
      {main}
      <button onClick={addNew} className="add">
        Add+
      </button>
      <br />
      <br />
